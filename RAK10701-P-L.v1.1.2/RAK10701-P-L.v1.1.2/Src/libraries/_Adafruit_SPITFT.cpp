...
#elif defined(NRF52840_XXAA) // Adafruit nRF52 use SPIM3 DMA at 32Mhz
  if (!bigEndian) {
...
#elif defined(NRF52840_XXAA) // Adafruit nRF52840 use SPIM3 DMA at 32Mhz
