...
void subPageHandling(void)
{
	...
	else if ((area == DATE1_AREA) || (area == DATE2_AREA) || (area == DATE3_AREA) || (area == DATE4_AREA) || (area == DATE5_AREA) || (area == DATE6_AREA) || (area == DATE7_AREA) || (area == DATE8_AREA) || (area == DATE9_AREA) || (area == DATE10_AREA) && (getPageNum() != SETTINGS_PAGE) && (getPageNum() != RESTART_PAGE))
	{
		switch (getPageNum())
		{
		case HOTSPOTS_PAGE:
