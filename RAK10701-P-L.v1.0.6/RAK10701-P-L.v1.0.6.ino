...
//  {
//    init_setAppKEY_at();
//    get_at_setting(APP_KEY_OFFSET);
////    for(int i = 0 ;i < 30 ; i++)
////    {
////      Serial.println(i);
////      Serial.println(atcmd_info_tbl[i].atCmd); 
////    }
//    atcmd_info_tbl[8].permission = RAK_ATCMD_PERM_DISABLE;  // AT+BAT
//    atcmd_info_tbl[24].permission = RAK_ATCMD_PERM_DISABLE; // AT+APPKEY
